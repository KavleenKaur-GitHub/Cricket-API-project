...
***THIS TABLE SHOWS THE ERROR MESSAGES OF ALL THE URLS WHICH IS ILLUSTRATED USING JUST ONE URL.AS SHOWN BY THE TABLE, THE ERROR MESSAGES COVERED IN THE API ARE AS FOLLOWS:***
...
### URL COVERED AND WHAT ANALYTICAL QUERIES DO THEY SOLVE:
